...
architecture rtl of retimer is
    ...
    --
    -- DMB: Fine tunning done on a scope!

    constant OUTPUT_OFFSET        : integer := 1024 - 59;
    ...
    signal de_out1     : std_logic := '0';
    signal de_out2     : std_logic := '0';
...
begin
    ...
    -- pass vsync through synchronised version of vs, hs and de
    vs_out <= vs_out2;
    hs_out <= hs_out2;
    de_out <= de_out2;
