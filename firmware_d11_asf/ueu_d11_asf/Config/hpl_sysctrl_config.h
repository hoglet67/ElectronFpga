...
// <i> Indicates whether Bypass coarse lock is enabled or not (ignored with USBCRM)
...
// <i> Quick Lock Disable (unset for USBCRM)
...
// <i> Chill Cycle Disable (set for USBCRM)
...
// <CONF_DFLL_OPEN_LOOP_MODE"> Open Loop Mode (use this for USBCRM)
...
// <o> Coarse Maximum Step <0x0-0x1F> -- ignored when using USBCRM
// <id> dfll_arch_cstep
#ifndef CONF_DFLL_CSTEP
#define CONF_DFLL_CSTEP 0x1F
#endif

// <o> Fine Maximum Step <0x0-0x3FF> -- 0xA when using USBCRM
// <id> dfll_arch_fstep
...
// 	<i> Set the DFLL Multiply Factor -- 48000 when using USBCRM
//  <i> Default: 0
//  <id> dfll48m_mul
...
// <i> Indicates whether Overwrite Calibration value of DFLL (0 = read calibration value)
// <id> dfll48m_arch_calibration
#ifndef CONF_DFLL_OVERWRITE_CALIBRATION
#define CONF_DFLL_OVERWRITE_CALIBRATION 0
#endif

// <o> Coarse Value <0x0-0x3F> (unused unless overwriting calibration)
// <id> dfll48m_arch_coarse
#ifndef CONF_DFLL_COARSE
#define CONF_DFLL_COARSE (0x1f)
#endif

// <o> Fine Value <0x0-0x3FF> (unused unless overwriting calibration)
